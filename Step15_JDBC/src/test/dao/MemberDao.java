...
public class MemberDao {
		...
		public MemberDto getByNum(int num) {
			...
			try {
				...
				while (rs.next()) {
					// 회원 한명의 정보를 담는다. -> List가 아닌 MemberDto 객체
					dto = new MemberDto();
					dto.setNum(num); // 회원의 번호는 매개변수에 들어있는 내요을 담으면 된다. 
		...
		public List<MemberDto> selectAll(){
			...
			try {
				...
				while (rs.next()) {
		            ...
		            // MemberDto 객체 생성 후 담기 
		            MemberDto dto = new MemberDto();
		            dto.setNum(num);
		            dto.setName(name);
		            dto.setAddr(addr);
		            
		            // 회원 한명의 정보가 담긴 새로운 MemberDto 객체의 참조값을 List에 누적시키기 (생성 후 담은 MemberDto 를 list 에 추가하기) 
					list.add(dto);
				}
			} catch (Exception e) {
	...
	// ==============================================================================
		// 회원 한명의 정보를 DB 에서 수정하고 성공 여부를 리턴하는 메소드
...
// ==============================================================================
		...
		// 회원한명의 정보를 DB에서 삭제하고 성공여부를 리턴하는 메소드 
